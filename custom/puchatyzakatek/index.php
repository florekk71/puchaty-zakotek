...
<script src="js/app.js?v=0.5.8-limits"></script><script src="js/reports.js?v=0.5.5"></script><script src="js/visit-reports.js?v=0.5.5"></script><script src="js/commerce.js?v=0.5.8-limits"></script>
</body>
</html>