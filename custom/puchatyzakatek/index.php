...
<link rel="stylesheet" href="css/admin-portal.css?v=8" media="screen">
</head>
<body>
<div class="app">
  <aside class="sidebar">
...
<script src="js/app.js?v=0.6.14-mobile-calendar"></script><script src="js/table-sort.js?v=2"></script><script src="js/calendar-touch.js?v=2"></script><script src="js/reports.js?v=0.5.5"></script><script src="js/visit-reports.js?v=0.5.5"></script><script src="js/commerce.js?v=0.6.14-mobile-calendar"></script>
</body>
</html>
