...
<script src="js/app.js?v=0.6.14-mobile-calendar"></script><script src="js/calendar-touch.js?v=2"></script><script src="js/reports.js?v=0.5.5"></script><script src="js/visit-reports.js?v=0.5.5"></script><script src="js/commerce.js?v=0.6.14-mobile-calendar"></script>
</body>
</html>