...
<link rel="stylesheet" href="css/admin-portal.css?v=1" media="screen">
</head>
<body>
<div class="app">
  <aside class="sidebar">
...
<script src="js/app.js?v=0.6.3-next-appointment"></script><script src="js/reports.js?v=0.5.5"></script><script src="js/visit-reports.js?v=0.5.5"></script><script src="js/commerce.js?v=0.6.1-owner"></script>
</body>
</html>