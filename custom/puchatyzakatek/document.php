...
try{
 ...
 $logo=!empty($seller['logo'])?'@'.base64_decode(substr($seller['logo'],strlen('data:image/jpeg;base64,')),true):__DIR__.'/img/logo.jpg';
 ...
 header('Content-Type: application/pdf');header('Content-Disposition: inline; filename="'.$filename.'"');echo $bytes;
